...
public class GetAllModulesQueryHandler : IRequestHandler<GetAllModulesQuery, AppModule[]>
{
    ...
    public async Task<AppModule[]> Handle(GetAllModulesQuery request, CancellationToken cancellationToken)
    {
