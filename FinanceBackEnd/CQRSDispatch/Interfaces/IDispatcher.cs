...
public interface IDispatcher
{
    ...
    Task<TResult> DispatchAsync<TResult>(ICommand<TResult> command, HttpRequest httpRequest)
    ...
    Task<CommandResult> DispatchCommandAsync(ICommand command, HttpRequest httpRequest);
    ...
    /// </summary>
    /// <typeparam name="TData">The data type returned by the query</typeparam>
    /// <param name="query">The query to dispatch</param>
    /// <param name="httpRequest">The HTTP request context</param>
    /// <returns>A DataResult containing the queried data or error information</returns>
    Task<DataResult<TData>> DispatchQueryAsync<TData>(IQuery<TData> query, HttpRequest httpRequest);
    ...
    /// <param name="query">The query to dispatch</param>
    /// <returns>A DataResult containing the queried data or error information</returns>
    Task<DataResult<TData>> DispatchQueryAsync<TData>(IQuery<TData> query);
}