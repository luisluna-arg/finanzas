...
public class AppModuleTypeQueryController(IMappingService mapper, IDispatcher<FinanceDispatchContext> dispatcher) : ApiBaseQueryController<AppModuleType, AppModuleTypeEnum, AppModuleTypeDto>(mapper, dispatcher)
{
    [HttpGet]
