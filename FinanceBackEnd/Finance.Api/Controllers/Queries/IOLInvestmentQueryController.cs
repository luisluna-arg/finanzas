...
using Finance.Application.Legacy.Queries.IOLInvestments;
...
public class IOLInvestmentQueryController(IMappingService mapper, IDispatcher<FinanceDispatchContext> dispatcher)
