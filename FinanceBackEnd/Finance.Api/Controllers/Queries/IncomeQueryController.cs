...
using Finance.Application.Legacy.Queries.Incomes;
...
public class IncomeQueryController(IMappingService mapper, IDispatcher<FinanceDispatchContext> dispatcher)
