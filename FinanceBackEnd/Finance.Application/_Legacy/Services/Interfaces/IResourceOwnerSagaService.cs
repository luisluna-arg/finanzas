...
namespace Finance.Application.Legacy.Services.Interfaces;

public interface IResourcePermissionsSagaService<TResourceEntity, TOrchestrator, SetRequest, SetResult, DeleteRequest, DeleteResult>
    ...
    where TOrchestrator : IResourcePermissionsOrchestrator<SetRequest, SetResult, DeleteRequest, DeleteResult>, new()
{
