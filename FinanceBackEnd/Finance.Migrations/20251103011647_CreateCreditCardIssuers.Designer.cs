...
namespace Finance.Domain.Migrations
{
    ...
    [Migration("20251103011647_CreateCreditCardIssuers")]
    partial class CreateCreditCardIssuers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCard", b =>
                {
                    ...
                    b.Property<Guid?>("CreditCardIssuerId1")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("CurrentStatementId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("CurrentStatementId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreditCardIssuerId1");

                    b.HasIndex("CurrentStatementId1");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCardTransaction", b =>
                {
                    ...
                    b.Property<Guid?>("StatementTransactionId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StatementTransactionId1");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCard", b =>
                {
                    ...
                    b.HasOne("Finance.Domain.Models.CreditCardIssuer", null)
                        .WithMany("CreditCards")
                        .HasForeignKey("CreditCardIssuerId1");

                    b.HasOne("Finance.Domain.Models.CreditCardStatement", "CurrentStatement")
                        .WithMany()
                        .HasForeignKey("CurrentStatementId1");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCardStatementTransaction", b =>
                {
                    b.HasOne("Finance.Domain.Models.CreditCard", null)
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCardTransaction", b =>
                {
                    ...
                    b.HasOne("Finance.Domain.Models.CreditCardStatementTransaction", "StatementTransaction")
                        .WithMany()
                        .HasForeignKey("StatementTransactionId1");
