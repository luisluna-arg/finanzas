...
using Finance.Application.Legacy.Queries.Summary;
...
[Route("api/summary")]
public class SummaryQueryController(IMappingService mapper, IDispatcher<FinanceDispatchContext> dispatcher)
