...
public class CreateCurrencyExchangeRatePermissionsCommand
    : CreateResourcePermissionsCommand<CurrencyExchangeRate, Guid, CurrencyExchangeRatePermissions>;
...
{
    protected override async Task<CurrencyExchangeRate?> QuerySource(
        CreateCurrencyExchangeRatePermissionsCommand request, CancellationToken cancellationToken)
    {
