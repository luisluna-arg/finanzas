...
public class GetAllCurrencyExchangeRatesQueryHandler : BaseCollectionQueryHandler<GetAllCurrencyExchangeRatesQuery, CurrencyExchangeRate>
{
    public GetAllCurrencyExchangeRatesQueryHandler(FinanceDbContext db) : base(db) { }

    public override async Task<DataResult<List<CurrencyExchangeRate>>> ExecuteAsync(
        GetAllCurrencyExchangeRatesQuery request, CancellationToken cancellationToken)
    {
