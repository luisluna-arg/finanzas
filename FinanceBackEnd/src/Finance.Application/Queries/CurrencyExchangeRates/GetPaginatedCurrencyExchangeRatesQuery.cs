...
public class GetPaginatedCurrencyExchangeRatesQueryHandler : IQueryHandler<GetPaginatedCurrencyExchangeRatesQuery, PaginatedResult<CurrencyExchangeRate?>>
{
    ...
    public GetPaginatedCurrencyExchangeRatesQueryHandler(FinanceDbContext dbContext)
    {
        this.dbContext = dbContext;
    }

    public async Task<DataResult<PaginatedResult<CurrencyExchangeRate?>>> ExecuteAsync(
        GetPaginatedCurrencyExchangeRatesQuery request, CancellationToken cancellationToken)
    {
