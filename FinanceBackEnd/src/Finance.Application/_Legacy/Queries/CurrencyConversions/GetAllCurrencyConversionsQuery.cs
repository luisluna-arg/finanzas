...
public class GetAllCurrencyConversionsQueryHandler(FinanceDbContext db) : BaseCollectionQueryHandler<GetAllCurrencyConversionsQuery, CurrencyConversion>(db)
{
