...
namespace Finance.Domain.Migrations
{
    ...
    [Migration("20260913094817_AddCreditCardPaymentPlansAndPatterns")]
    partial class AddCreditCardPaymentPlansAndPatterns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance.Domain.Models.Auth.BankCurrencyPermissions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BankId", "CurrencyId", "UserId")
                        .IsUnique();

                    b.ToTable("BankCurrencyPermissions");
                });
            ...
            modelBuilder.Entity("Finance.Domain.Models.BankCurrencies.BankCurrency", b =>
                {
                    b.Property<Guid>("BankId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCards.CreditCardInstallmentPattern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CreditCardInstallmentPattern");
                });
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCards.CreditCardPaymentPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BaseConcept")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("CreditCardId", "BaseConcept", "TotalInstallments", "CurrencyId");

                    b.ToTable("CreditCardPaymentPlan");
                });
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCards.CreditCardStatementImportTemplate", b =>
                {
                    ...
                    b.Property<Guid?>("InstallmentPatternId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("InstallmentPatternId");
            ...
            modelBuilder.Entity("Finance.Domain.Models.Auth.BankCurrencyPermissions", b =>
                {
                    ...
                    b.HasOne("Finance.Domain.Models.BankCurrencies.BankCurrency", "BankCurrency")
                        .WithMany()
                        .HasForeignKey("BankId", "CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BankCurrency");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCards.CreditCardStatementImportTemplate", b =>
                {
                    b.HasOne("Finance.Domain.Models.CreditCards.CreditCardInstallmentPattern", "InstallmentPattern")
                        .WithMany()
                        .HasForeignKey("InstallmentPatternId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("InstallmentPattern");
            ...
            modelBuilder.Entity("Finance.Domain.Models.CreditCards.CreditCardTransaction", b =>
                {
                    ...
                    b.HasOne("Finance.Domain.Models.CreditCards.CreditCardPaymentPlan", "PaymentPlan")
                        .WithMany("Transactions")
