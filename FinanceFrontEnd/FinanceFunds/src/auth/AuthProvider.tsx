  ...
  if (!isConfigValid) {
    return (
      <div className="auth-error">
        ...
        <p>{configError || 'Invalid Auth0 configuration. Please check your .env file.'}</p>
        <p>Please refer to the AUTH0-SETUP.md and ENV-SETUP.md files for setup instructions.</p>
      </div>
    );
  }
  interface AppState {
